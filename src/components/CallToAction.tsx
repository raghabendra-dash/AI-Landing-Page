        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="glass-card p-12 md:p-16 rounded-3xl glow-primary text-center space-y-8 animate-fade-in">
            <div className="inline-flex items-center gap-2 glass-card px-6 py-3 rounded-full mb-4">
              ...
              <span className="text-sm font-mono text-muted-foreground">Join the Revolution</span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-16">
            <div className="glass-card p-8 rounded-2xl glow-primary hover:scale-105 transition-transform group">
              ...
              <p className="text-muted-foreground mb-6">
                Comprehensive SDKs, detailed documentation, and developer tools to help you 
            ...
            <div className="glass-card p-8 rounded-2xl glow-primary hover:scale-105 transition-transform group">
              ...
              <p className="text-muted-foreground mb-6">
                Enterprise-grade infrastructure with dedicated support, custom integrations, 
                and guaranteed SLAs for mission-critical applications.
              </p>
              <ul className="space-y-3 text-sm">
                <li className="flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-accent" />
